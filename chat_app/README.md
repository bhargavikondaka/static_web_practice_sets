...
Today I built a **Chat Application UI** using HTML and CSS!
...
- Making the layout look like a real chat app
- Getting the spacing and padding right

---

## ✅ How I Fixed It
- Used Flexbox justify-content to align bubbles
...
> but every pixel matters when you actually build it!" 🎨
